import unittest
from aoc_18 import add,split,reduce,sum,calc_magnitude,max_magnitude
...
class TestDay18(unittest.TestCase):
    ...
    def test_split(self):
        self.assertEqual(split(15, [1,15], 1), [1,[7,8]])

    def test_reduce_a1(self):
        self.assertEqual(reduce([1, 15]), [1,[7,8]])

    def test_reduce_a2(self):
        self.assertEqual(reduce([[1,1], 15]), [[1,1],[7,8]])

    def test_reduce_1(self):
        self.assertEqual(reduce([[[[[9,8],1],2],3],4]), [[[[0,9],2],3],4])

    def test_reduce_2(self):
        self.assertEqual(reduce([7,[6,[5,[4,[3,2]]]]]), [7,[6,[5,[7,0]]]])

    def test_reduce_3(self):
        self.assertEqual(reduce([[6,[5,[4,[3,2]]]],1]), [[6,[5,[7,0]]],3])

    def test_reduce_4(self):
        self.assertEqual(reduce([[3,[2,[1,[7,3]]]],[6,[5,[4,[3,2]]]]]), [[3,[2,[8,0]]],[9,[5,[7,0]]]])

    def test_reduce_5(self):
        self.assertEqual(reduce([[3,[2,[8,0]]],[9,[5,[4,[3,2]]]]]), [[3,[2,[8,0]]],[9,[5,[7,0]]]])
    ...
    def test_sum_to_magnitude(self):
        self.assertEqual(calc_magnitude(sum(
            [
    ...
    def test_max_magnitude(self):
        self.assertEqual(max_magnitude(
            [
                [[[0, [5, 8]], [[1, 7], [9, 6]]], [[4, [1, 2]], [[1, 4], 2]]],
                [[[5, [2, 8]], 4], [5, [[9, 9], 0]]],
                [6, [[[6, 2], [5, 6]], [[7, 6], [4, 7]]]],
